...
<!-- HERO: sezione introduttiva con headline e call-to-action -->
<section class="hero">
  <div class="hero-text">
    ...
    <div class="hero-actions">
      <!-- Link interno che scorre alla sezione prodotti in evidenza -->
  ...
  <!-- Segnaposto grafico: qui potresti sostituire con un'immagine reale -->
  <div class="img-placeholder" aria-hidden="true">Anteprima iPhone</div>
</section>
