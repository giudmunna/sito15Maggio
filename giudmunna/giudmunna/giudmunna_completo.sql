...
--
-- Se devi aggiungere il carrello su DB già esistente, prima allinea i tipi:
--   ALTER TABLE clienti  MODIFY id_cliente  INT UNSIGNED NOT NULL AUTO_INCREMENT;
--   ALTER TABLE prodotti MODIFY id_prodotto INT UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Poi crea tabella carrello (blocchi separati in phpMyAdmin, con ; finale):
--   CREATE TABLE carrello (
--     id_carrello INT UNSIGNED NOT NULL AUTO_INCREMENT,
--     id_cliente INT UNSIGNED NOT NULL,
--     id_prodotto INT UNSIGNED NOT NULL,
--     quantita INT UNSIGNED NOT NULL DEFAULT 1,
...
-- NOTA: tipi FK allineati a clienti/prodotti => INT UNSIGNED.
